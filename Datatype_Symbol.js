...
const val2=Symbol('js') //hen you create a Symbol using Symbol('js'), you're creating a new unique Symbol each time.
console.log(val1===val2)//false Wunique Symbol each time
